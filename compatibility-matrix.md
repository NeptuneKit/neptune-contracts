...
|---|---|---|---|---|
| neptune-gateway-swift | CLI/macOS app | ^2.0.0-alpha.1 | `0abfa0b` | Center gateway and query service |
| neptune-sdk-ios | SPM | ^2.0.0-alpha.1 | `5375a57` | Local serve + export contract |
